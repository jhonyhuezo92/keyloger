...
class Interfaz:
    def __init__(self, ventana):
        ...
        self.pantalla=Text(ventana, state="disabled", width=40, height=3, background="white", foreground="black", font=("Calibr",20))
        ...
        boton17=self.crearBoton("=",escribir=False,ancho=10,alto=2)
    ...
    def crearBoton(self, valor, escribir=True, ancho=12, alto=1):
        return Button(self.ventana, text=valor, width=ancho, height=alto, font=("Helvetica",1), command=lambda:self.click(valor,escribir))
